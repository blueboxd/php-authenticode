...
namespace Kaitai\Parser;

class MicrosoftPe extends \Kaitai\Struct\Struct {

    public function __construct(\Kaitai\Struct\Stream $io, \Kaitai\Struct\Struct $parent = null, \Kaitai\Parser\MicrosoftPe $root = null) {
        parent::__construct($io, $parent, $root);
        $this->_parse();
    }
    private function _parse() {
        $this->_m_mz1 = new \Kaitai\Parser\MicrosoftPe\MzPlaceholder($this->_io, $this, $this->_root);
        $this->_m_mz2 = $this->_io->readBytes(($this->mz1()->headerSize() - 64));
        $this->_m_peSignature = $this->_io->ensureFixedContents("\x50\x45\x00\x00");
        $this->_m_coffHdr = new \Kaitai\Parser\MicrosoftPe\CoffHeader($this->_io, $this, $this->_root);
        ...
        $this->_m_optionalHdr = new \Kaitai\Parser\MicrosoftPe\OptionalHeader($io, $this, $this->_root);
        $this->_m_sections = [];
        $n = $this->coffHdr()->numberOfSections();
        for ($i = 0; $i < $n; $i++) {
            $this->_m_sections[] = new \Kaitai\Parser\MicrosoftPe\Section($this->_io, $this, $this->_root);
        }
    }
    protected $_m_mz1;
    protected $_m_mz2;
...
namespace Kaitai\Parser\MicrosoftPe;

class OptionalHeaderWindows extends \Kaitai\Struct\Struct {

    public function __construct(\Kaitai\Struct\Stream $io, \Kaitai\Parser\MicrosoftPe\OptionalHeader $parent = null, \Kaitai\Parser\MicrosoftPe $root = null) {
        parent::__construct($io, $parent, $root);
        $this->_parse();
    }
    private function _parse() {
        if ($this->_parent()->std()->format() == \Kaitai\Parser\MicrosoftPe\PeFormat::PE32) {
            $this->_m_imageBase32 = $this->_io->readU4le();
        }
        if ($this->_parent()->std()->format() == \Kaitai\Parser\MicrosoftPe\PeFormat::PE32_PLUS) {
...
namespace Kaitai\Parser\MicrosoftPe\OptionalHeaderWindows;
...
class OptionalHeaderDataDirs extends \Kaitai\Struct\Struct {
    ...
    private function _parse() {
        $this->_m_exportTable = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_importTable = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_resourceTable = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_exceptionTable = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_certificateTable = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_baseRelocationTable = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_debug = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_architecture = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_globalPtr = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_tlsTable = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_loadConfigTable = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_boundImport = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_iat = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_delayImportDescriptor = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
        $this->_m_clrRuntimeHeader = new \Kaitai\Parser\MicrosoftPe\DataDir($this->_io, $this, $this->_root);
    }
...
class DataDir extends \Kaitai\Struct\Struct {
    ...
    public function __construct(\Kaitai\Struct\Stream $io, \Kaitai\Parser\MicrosoftPe\OptionalHeaderDataDirs $parent = null, \Kaitai\Parser\MicrosoftPe $root = null) {
        parent::__construct($io, $parent, $root);
        $this->_parse();
    }
    private function _parse() {
...
class OptionalHeader extends \Kaitai\Struct\Struct {
    ...
    public function __construct(\Kaitai\Struct\Stream $io, \Kaitai\Parser\MicrosoftPe $parent = null, \Kaitai\Parser\MicrosoftPe $root = null) {
        parent::__construct($io, $parent, $root);
        $this->_parse();
    }
    private function _parse() {
        $this->_m_std = new \Kaitai\Parser\MicrosoftPe\OptionalHeaderStd($this->_io, $this, $this->_root);
        $this->_m_windows = new \Kaitai\Parser\MicrosoftPe\OptionalHeaderWindows($this->_io, $this, $this->_root);
        $this->_m_dataDirs = new \Kaitai\Parser\MicrosoftPe\OptionalHeaderDataDirs($this->_io, $this, $this->_root);
    }
    protected $_m_std;
...
class OptionalHeaderStd extends \Kaitai\Struct\Struct {
    ...
    private function _parse() {
        ...
        if ($this->format() == \Kaitai\Parser\MicrosoftPe\PeFormat::PE32) {
...
namespace Kaitai\Parser\MicrosoftPe\CoffHeader;
