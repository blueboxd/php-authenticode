...
class Length implements Encodable
{
     ...
     */
    public function __construct($length, bool $indefinite = false, $lengthBytes = 0)
    {
...
//		var_dump($length, $indefinite, $lengthBytes);
        return new self($length, $indefinite,$lengthBytes);
    }
